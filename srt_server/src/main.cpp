        ...
        while (g_running.load()) {
            ...
            if (cfg_.ws_port > 0 && ws_.client_count() > 0) {
                ...
                j << "{"
                  ...
                  << "\"dash_last_ack_ms\":" << (dash_last_ack_ms_.load() > 0 ? steady_ms() - dash_last_ack_ms_.load() : -1) << ","
                  << "\"ingress_hist\":[";
                ...
                j << "],\"sub_list\":[";
                {
                    ...
                    for (auto& [id, sess] : subscribers_) {
                        ...
                        j << "{"
                          ...
                          << "\"telemetry_last_ack_ms\":" << (sess->telemetryLastAckMs() > 0 ? steady_ms() - sess->telemetryLastAckMs() : -1) << ","
